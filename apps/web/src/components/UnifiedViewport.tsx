...
export const UnifiedViewport: React.FC = () => {
  ...
  // Same fixed session used for the Passport, so trivia scoring and
  // passport lookups always agree on who "the traveler" is.
  ...
  return (
      ...
      >
              ...
              <div className="flex items-center justify-between p-4 border-b border-white/10 shrink-0">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                      ...
                      className="text-xs font-mono font-bold text-neutral-950 bg-amber-500 hover:bg-amber-400 px-3 py-1.5 rounded-full transition-colors min-h-[32px]"
                  >
                    Trivia
                  </button>
                  <button
        ...
        {activeStation && (
            <TriviaPrompt
                waypointId={activeStation.id ?? activeStation.stationId ?? ''}
                sessionId={sessionId}
                isOpen={isTriviaOpen}
